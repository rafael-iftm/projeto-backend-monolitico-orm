...
public class LeilaoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		ItemDeLeilao bicicleta = new ItemDeLeilao("Bicicleta", 140.0, true);
		Participante rafael = new Participante("Rafael", "021029");
		Lance lance = new Lance(100.0, rafael);
		bicicleta.getLancesRecebidos().add(lance);

		participante.save(rafael);
